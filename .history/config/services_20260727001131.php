...
return [
    ...
    */
    ...
    'pesapal' => [
    'env' => env('PESAPAL_ENV', 'sandbox'), // sandbox | production
    'consumer_key' => env('PESAPAL_CONSUMER_KEY'),
    'consumer_secret' => env('PESAPAL_CONSUMER_SECRET'),
    'ipn_url' => env('PESAPAL_IPN_URL'), // must be a public HTTPS URL reachable by Pesapal
    'ipn_id' => env('PESAPAL_IPN_ID'), // optional — leave blank to auto-register on first use
],
