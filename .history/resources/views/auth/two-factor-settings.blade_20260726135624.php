...
<ul class="nav nav-pills mb-4">
    ...
    <li class="nav-item"><a class="nav-link active" href="{{ route('two-factor.show') }}">Two-Factor Security</a></li>
</ul>
...
<div class="card"><div class="card-body">
    @if ($user->hasTwoFactorEnabled())
        ...
        <form method="POST" action="{{ route('two-factor.disable') }}" onsubmit="return confirm('Disable two-factor authentication?');">
            @csrf @method('DELETE')
    ...
    @else
        ...
        <form method="POST" action="{{ route('two-factor.confirm') }}" class="row g-2" style="max-width:400px;">
            @csrf
