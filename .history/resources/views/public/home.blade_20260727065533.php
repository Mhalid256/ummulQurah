    ...
    <header>
        <div class="header-container">
            ...
            <nav>
                ...
                <button class="donate-btn" onclick="scrollToCTA()">Donate</button>
            </nav>
        </div>
    </header>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <div class="hero-buttons">
                ...
                <button class="btn-secondary" onclick="document.getElementById('campaigns').scrollIntoView({behavior: 'smooth'})">See Campaigns</button>
            </div>
        </div>
    </section>
    ...
    <section class="cta" id="cta">
        <div class="cta-container">
            ...
            <div class="donation-tiers">
                <button class="tier-btn" onclick="handleDonation(50)">$50</button>
                <button class="tier-btn" onclick="handleDonation(100)">$100</button>
                <button class="tier-btn" onclick="handleDonation(250)">$250</button>
                <button class="tier-btn" onclick="handleDonation(500)">$500</button>
            </div>
            <button class="btn-primary" onclick="handleCustomDonation()">Custom Amount</button>
        </div>
    </section>
