...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // --- Area Chart: Donations Trend ---
    const labels = @json(isset($monthlyDonations) ? $monthlyDonations->pluck('ym') : ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun']);
    const values = @json(isset($monthlyDonations) ? $monthlyDonations->pluck('total') : [1200, 1900, 3000, 5000, 4200, 6800]);
