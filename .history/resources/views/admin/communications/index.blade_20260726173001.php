...
<div class="card">
    ...
    <div class="alert alert-info m-3">
        Sending is stubbed in this build phase &mdash; messages are logged with a computed recipient count. Wiring a real email/SMS/WhatsApp provider is a drop-in addition later.
    </div>
